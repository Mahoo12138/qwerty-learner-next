  ...
  return (
    <>
      ...
      >
        ...
        <br /> <br />
        <a className="mr-5 underline dark:text-gray-300" href="https://github.com/mahoo12138/qwerty-learner-next-vscode">
          GitHub 项目
        </a>
        <a className="underline dark:text-gray-300" href="https://marketplace.visualstudio.com/items?itemName=Kaiyi.qwerty-learner-next">
          VSCode 插件链接
        </a>
        <br />
      </InfoPanel>
      ...
      <footer className="mb-1 mt-4 flex w-full items-center justify-center gap-2.5 text-sm ease-in" onClick={(e) => e.currentTarget.blur()}>
        <a href="https://github.com/mahoo12138/qwerty-learner-next" target="_blank" rel="noreferrer" aria-label="前往 GitHub 项目主页">
          <IconGithub fontSize={15} className="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-100" />
        </a>

        <a href="https://twitter.com/mahoo12138" target="_blank" title="x" rel="noreferrer">
        ...
        <a
          href="mailto:mahoo12138@qq.com"
          target="_blank"
          rel="noreferrer"
          onClick={(e) => e.currentTarget.blur()}
          aria-label="发送邮件到 mahoo12138@qq.com"
        >
          <IconMail fontSize={16} className="text-gray-500 hover:text-indigo-400 dark:text-gray-400 dark:hover:text-indigo-400" />
        </a>
        <a rel="noreferrer" className="cursor-pointer focus:outline-none" onClick={() => navigate({ to: '/friend-links' })} aria-label="查看友链">
